		...
		<div class="space-y-6" in:fly={{ y: 20, duration: 800, delay: 100 }}>
			...
			<Card class="bg-base-100 shadow-sm border border-base-content/10">
				...
				>
					...
					<div class="space-y-3">
						<Input type="password" name="currentPassword" placeholder="Password Saat Ini" class="bg-base-200/50" required />
						<Input type="password" name="newPassword" placeholder="Password Baru" class="bg-base-200/50" required />
						<Input type="password" name="confirmPassword" placeholder="Konfirmasi Password Baru" class="bg-base-200/50" required />
					</div>
