...
<div class="min-h-screen w-full grid lg:grid-cols-2">
	...
	<div class="hidden lg:flex relative flex-col justify-center items-center bg-base-200 text-base-content p-12 overflow-hidden">
		<!-- Animated Background -->
		<div class="absolute inset-0 w-full h-full bg-gradient-to-br from-primary/10 to-secondary/10 z-0"></div>
		...
		<div class="relative z-10 max-w-lg text-center space-y-8" in:fly={{ x: 20, duration: 1000, delay: 200, easing: quintOut }}>
			<div class="relative">
				...
				<div class="w-64 h-64 mx-auto bg-gradient-to-tr from-primary to-secondary rounded-3xl rotate-3 shadow-2xl flex items-center justify-center mb-12 group transition-transform hover:rotate-6 duration-500">
