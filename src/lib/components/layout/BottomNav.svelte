<script lang="ts">
	import { House, User, Plus, Flame, BookOpen } from 'lucide-svelte';
	...
	const isHidden = $derived($page.url.pathname.startsWith('/almatsurat'));
		...
		>
			...
			<div class="relative -top-6 flex flex-col items-center justify-center px-2">
				...
				<button
					...
					class="relative flex size-16 items-center justify-center rounded-full bg-linear-to-tr from-primary to-purple-600 text-white shadow-xl shadow-primary/30 transition-transform duration-300 hover:scale-105 active:scale-95"
				>
